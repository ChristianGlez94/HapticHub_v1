...
public class PieneActivity extends AppCompatActivity implements ServiceConnection {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_piene);
        ...
        String actuation=sharedPreferences.getString("actuation","3");
